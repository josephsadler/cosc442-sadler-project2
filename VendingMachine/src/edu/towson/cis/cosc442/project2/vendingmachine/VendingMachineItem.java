...
public class VendingMachineItem {
	...
	/**
	 * Constructor which fills in the name and price of the item Precondition:
	 * price argument >= 0 Postcondition: The name and price of the item is set
	 * to be the values in the arguments
	 * 
	 * @param name
	 *            The name of the item
	 * @param price
	 ...
	 *             Thrown if price is less than zero
	 */
	 ...
	 * 
	 * @return The price of the vending machine item in dollars Postcondition:
	 *         The actual price of the item is returned
	 */
